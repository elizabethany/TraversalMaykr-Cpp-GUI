...
static const QStringList idleAnimationsImp = { "NONE", "wallclimb_hangout/idle", "upright_hangout/idle", "poleclimb_hangout/idle", "perch/pch_idle_pch" };
